...
- In one or two sentences, describe how this project changed the way you think about AI generated code.
  - From this project I learned that AI generated code can seem impressive on the outside but its not always correct. I noticed this just from the starter code that was provided. Then even when you begin to debug and fix the code, one has to be very careful and not just accept the suggestions blindly. This is because some suggestions were good but others weren't. I remember this suggestion it gave me about the scoring logic which was good but the way it handled the fix wasn't what I expected it to be despite the test cases passing. I also learned that AI can be a very helpful tool for debugging and testing but it should be used as a teammate rather than a crutch. It's important to understand the code and the bugs yourself in order to effectively use AI to help you fix them.
